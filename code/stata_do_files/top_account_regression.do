...
reghdfe is_mismatched b2i.leaning_id i.state_id top_account_democrat top_account_republican persona_anti_rate num_videos_watched transcript_availability_rate engagement_score_persona likes_per_recommendation comments_per_recommendation opp_pro persona_count duration videocount followercount sharecount, vce(cluster week device)
...
export delimited parm estimate p p_corrected stderr using "../../Desktop/Work/TikTok_New/data/tables/top_account_regression_output_raw.csv", replace
