...
exp_scaling = pd.read_csv('../data/model_data/anti_exponential.csv')
linear_scaling = pd.read_csv('../data/model_data/anti_linear.csv')
no_scaling = pd.read_csv('../data/model_data/anti_none.csv')
...
def convert_to_weekly_values_anti(df):
    weeks = []
    rep_true_values = []
    dem_true_values = []
    ...
    for week in df.week.unique():
        ...
        rep_true_values.append(ad)
        dem_true_values.append(ar)
...
rep_bots_true = convert_to_weekly_values_anti(rep_bots)
...
dem_bots_true = convert_to_weekly_values_anti(dem_bots)
...
fig.savefig('../figures/figure_4D.pdf', bbox_inches = 'tight', dpi = 300, transparent=True)
