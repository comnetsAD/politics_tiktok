...
odds_ratios = pd.read_csv('../data/regression_data/figure_3C_regression_results.csv')
...
plt.savefig('../figures/figure_3C.pdf', dpi=300, bbox_inches='tight', transparent = True)
